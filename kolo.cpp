...
Kolo::Kolo(QWidget* parent) : QWidget (parent) //constructor was changed,previously: Kolo::Kolo()
{
    ...
    player->setMedia(QUrl("qrc:/sounds/beep.wav"));
    player->setVolume(50);
    x=new QPixmap(":/images/eye/opened.png");
    x2=new QPixmap(":/images/eye/closed.png");
    *x=x->scaled(100,100);
    *x2=x2->scaled(100,100);
    kolo = new QGraphicsPixmapItem(*x);
    kolo->setX(275);
    kolo->setY(300);
    scena->addItem(kolo);
    nast=new QPushButton(QIcon(QPixmap(":/images/buttons/right.png").scaled(50,70)),"",this);
    ...
    poprz=new QPushButton(QIcon(QPixmap(":/images/buttons/left.png").scaled(50,70)),"",this);
